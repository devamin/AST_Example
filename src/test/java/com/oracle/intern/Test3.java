...
class Test3 {
	...
	private FuncNode funcNode = new FuncNode("test3", "a");

	
	private List<Node> getListOfInstructionBeforeOptimisation(){
		ArrayList<Node> listOfInst = new ArrayList<>();
		
		ForStatement forStatement = new ForStatement(new DeclarationStatement("i"), new Literal(0),Reference.get("a"), new ArrayList());
		//return a+1;
