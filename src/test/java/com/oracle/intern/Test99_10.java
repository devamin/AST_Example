 ...
 *
 	Assignement 9 : More Advanced Optimisation 
 *   
 *   
		function test10(a, b) {
			val result1;
	...
	!! we cannot merge this two ForStatement because they are not disjoint we used an element assigned in previous for
